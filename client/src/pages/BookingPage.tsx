...
const CalendarDay = ({ 
  ...
  <div 
    className={`calendar-day ${disabled ? 'calendar-day-disabled text-neutral-300 cursor-not-allowed' : 'cursor-pointer hover:bg-neutral-100'} ${selected ? 'bg-primary text-white' : ''} ${!currentMonth ? 'text-neutral-300' : ''} h-10 w-10 rounded-full flex items-center justify-center mx-auto`}
...
const BookingPage = () => {
  ...
  const handleDateSelect = (day: number) => {
    // Format date as YYYY-MM-DD (using September 2023 as example)
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-neutral-500 mb-4">Book an Inspection</h1>
            <p className="max-w-2xl mx-auto text-neutral-400">Schedule a fire safety inspection or service appointment with our expert team.</p>
          </div>
                        ...
                        <div>
                          ...
                          <div className="bg-neutral-50 rounded-lg p-4">
                            <div className="flex justify-between items-center mb-4">
                              <button type="button" className="text-neutral-500 hover:text-primary">
                            ...
                            <div className="grid grid-cols-7 gap-1">
                              {/* Previous month days */}
                              <CalendarDay day={27} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={28} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={29} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={30} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={31} disabled currentMonth={false} onSelect={handleDateSelect} />
                              
                              {/* Current month days */}
                              {[...Array(30)].map((_, i) => {
                                const day = i + 1;
                                const dateValue = `2023-09-${day.toString().padStart(2, '0')}`;
                                // Disable past days (for demo purposes, days 1-5)
                                const disabled = day < 6;
                              ...
                              {/* Next month days */}
                              <CalendarDay day={1} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={2} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={3} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={4} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={5} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={6} disabled currentMonth={false} onSelect={handleDateSelect} />
                              <CalendarDay day={7} disabled currentMonth={false} onSelect={handleDateSelect} />
                            </div>
                          </div>
                        </div>
                  ...
                  {showSuccess && (
                    <div className="text-center py-6">
                      ...
                      <p className="text-neutral-400 mb-6">
                        ...
                        at{" "}
                        <span className="font-semibold">
                          {new Date(`2023-01-01T${selectedTime}`).toLocaleTimeString('en-US', { 
                            hour: 'numeric', 
                            minute: 'numeric', 
                            hour12: true 
                          })}
